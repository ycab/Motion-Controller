...
{  
	unsigned char i,j,k;
	const unsigned char *temp=shuzi32;    
	temp+=index*64;	
	for(j=0;j<32;j++)
	{
		LCD_SetCursor(x,y+j);
...
//(x,y):中心点
//r    :半径
void Draw_Circle_D(u16 x0,u16 y0,u8 r,u16 x00,u16 y00,u16 x01,u16 y01)
{
	int a,b;
	int di;
	a=0;b=r;	  
	...
	while(a<=b)
	{
		if(x0-b>x00-1&&y0-a>y00)LCD_DrawPoint(x0-b+1,y0-a);             //3           
		if(x0+b<x01-1&&y0-a>y00)LCD_DrawPoint(x0+b+1,y0-a);             //0           
		if(x0-a>x00-1&&y0+b<y01)LCD_DrawPoint(x0-a+1,y0+b);             //1              
		if(x0-a>x00-1&&y0-b>y00)LCD_DrawPoint(x0-a+1,y0-b);             //2             
		if(x0+b<x01-1&&y0+a<y01)LCD_DrawPoint(x0+b+1,y0+a);             //4               
		if(x0+a<x01-1&&y0-b>y00)LCD_DrawPoint(x0+a+1,y0-b);             //5
		if(x0+a<x01-1&&y0+b<y01)LCD_DrawPoint(x0+a+1,y0+b);             //6 
		if(x0-b>x00-1&&y0+a<y01)LCD_DrawPoint(x0-b+1,y0+a);  
		
		if(x0-b>x00&&y0-a>y00)LCD_DrawPoint(x0-b,y0-a);             //3           
		if(x0+b<x01&&y0-a>y00)LCD_DrawPoint(x0+b,y0-a);             //0           
		if(x0-a>x00&&y0+b<y01)LCD_DrawPoint(x0-a,y0+b);             //1           
		if(x0-a>x00&&y0-b>y00)LCD_DrawPoint(x0-a,y0-b);             //2             
		if(x0+b<x01&&y0+a<y01)LCD_DrawPoint(x0+b,y0+a);             //4               
		if(x0+a<x01&&y0-b>y00)LCD_DrawPoint(x0+a,y0-b);             //5
		if(x0+a<x01&&y0+b<y01)LCD_DrawPoint(x0+a,y0+b);             //6 
		if(x0-b>x00&&y0+a<y01)LCD_DrawPoint(x0-b,y0+a);         

		if(x0-b>x00&&y0-a>y00-1)LCD_DrawPoint(x0-b,y0-a+1);             //3           
		if(x0+b<x01&&y0-a>y00-1)LCD_DrawPoint(x0+b,y0-a+1);             //0           
		if(x0-a>x00&&y0+b<y01-1)LCD_DrawPoint(x0-a,y0+b+1);             //1          
		if(x0-a>x00&&y0-b>y00-1)LCD_DrawPoint(x0-a,y0-b+1);             //2             
		if(x0+b<x01&&y0+a<y01-1)LCD_DrawPoint(x0+b,y0+a+1);             //4               
		if(x0+a<x01&&y0-b>y00-1)LCD_DrawPoint(x0+a,y0-b+1);             //5
		if(x0+a<x01&&y0+b<y01-1)LCD_DrawPoint(x0+a,y0+b+1);             //6 
		if(x0-b>x00&&y0+a<y01-1)LCD_DrawPoint(x0-b,y0+a+1);      
		a++;
		//使用Bresenham算法画圆     
		if(di<0)di +=4*a+6;	  
		else
		...
		if(x0+a<x01&&y0+b<y01)LCD_DrawPoint(x0+a,y0+b);
	}
} 
